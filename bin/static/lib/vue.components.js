/**
 *@description directive & component
 *@author	wupeng364@outlook.com
*/
// iview table 自动适应高度
Vue.directive('fs-tableautoheight',{
	/*** 绑定钩子函数 ***/
    ...
    componentUpdated: function (el, binding, vnode) {
		...
		this._AutoHeight( );
		window.addEventListener("resize", this._AutoHeight);
	},
	/*** 解除指令 ****/
    unbind: function () {
      window.removeEventListener("resize", this._AutoHeight);
    }
});
// 文件拷贝
