...
// 模块安装, 一个模块只初始化一次
func (fm *FileManageModule)OnMSetup( ref gomodule.ReferenceModule ) {
	
}
// 模块升级, 一个版本执行一次
func (fm *FileManageModule)OnMUpdate( ref gomodule.ReferenceModule ) {
...
// 系统执行销毁时执行
func (fm *FileManageModule)OnMDestroy( ref gomodule.ReferenceModule ) {
